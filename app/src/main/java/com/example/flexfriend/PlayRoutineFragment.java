...
import com.example.flexfriend.databinding.FragmentPlayRoutineBinding;
 ...
 */
public class PlayRoutineFragment extends Fragment implements View.OnClickListener {
    ...
    private String movementString, repsOrSecsString, setsString;
    ...
    private FragmentPlayRoutineBinding binding;
...
//        retreive values to display on screen accordingly, as strings and integers
        Bundle bundle = this.getArguments();
        if (bundle !=null) {
            movementString = bundle.getString("movement name");
            repsOrSecsString = bundle.getString("reps or sec");
            setsString = bundle.getString("sets");
        ...
        Log.d("fragment bundle content", String.valueOf(bundle));


        binding = FragmentPlayRoutineBinding.inflate(inflater, container, false);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.startTimerButton){
            if (sets>0 && !timerRunning) startSetTimer();
        }
    }
...
//    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.returnButton.setOnTouchListener(mDelayHideTouchListener);
    ...
    public void startSetTimer(){
        ct = new CountDownTimer(repsOrsecs * 1000L, 1000) {
            int i = repsOrsecs+1;
